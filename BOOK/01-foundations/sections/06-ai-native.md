...
پژوهش ۲۰۲۶ در *Information & Management*، Agentic AI را به‌عنوان سامانه‌هایی با قابلیت برنامه‌ریزی، استدلال و اقدام با میزان محدودی از نظارت انسانی بررسی می‌کند و در کنار فرصت‌های بهره‌وری، پیامدهایی مانند جابه‌جایی نقش‌های شغلی، شفافیت، حکمرانی و عدالت را مطرح می‌کند. citeturn856011search3
